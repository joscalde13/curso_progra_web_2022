...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion'])) {
        ...
        if ($result > 0) {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO cliente(dpi,nombre,telefono,direccion, usuario_id) values ('$dni', '$nombre', '$telefono', '$direccion', '$usuario_id')");
            if ($query_insert) {
        ...
        <div class="col-lg-6 m-auto">
            <form action="" method="post" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="number" placeholder="Ingrese DPI" name="dpi" id="dni" class="form-control">
                </div>
                <div class="form-group">
