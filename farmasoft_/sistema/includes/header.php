...
$usrClass = new headermodel();

$result = array();
$resultRoles = array();
$result = $usrClass->obtener_header();
...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<?php include_once "../sistema/includes/menu.php"; ?>
		<!-- Content Wrapper -->
				...
				<nav class="navbar navbar-expand navbar-light bg-primary text-white topbar mb-4 static-top shadow">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow">
							...
							<i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i><span class="mr-2 d-none d-lg-inline small text-white"><?php echo $_SESSION['nombre']; ?></span>
							</a>
							<!-- Dropdown - User Information -->
							<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
								<a class="dropdown-item" href="confi.php">
